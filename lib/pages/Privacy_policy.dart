                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Text("Privacy Policy",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w800,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.045),),
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text("Preamble",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                              ),
                      ...
                      Text("With the following privacy policy, we would like to inform you about the types of your personal data (hereinafter also referred to as “data”) that we process, for what purposes and to what extent in the context of providing our application.",
                        style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w600,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),),
                      Padding(
                        ...
                        children: [
                          Center(
                            child: Padding(
                              ...
                              child: Text("Relevant Legal Bases",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                          RichText(
                            text: TextSpan(
                              style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),
                              children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text("National data protection regulations in Germany:",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),),
                              ],
                            ),
                          ),
                          RichText(
                        ...
                        children: [
                          Center(
                            child: Padding(
                              ...
                              child:  Text("Overview processing",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                          Text("The following overview summarizes the types of data processed and the purposes of their processing, and refers to the data subjects.Types of data processed",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),),
                          Row(
                            children: [
                              Padding(
                                padding: const EdgeInsets.all(8.0),
                              ...
                              Text("Inventory data, Payment data, Contact data, Content data, Contract data, Usage data, Meta, communication and process data.",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Flexible(child: Text("Interested parties, users, business and contractual partners.",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),)),
                            ],
                          ),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 32.0, bottom: 16),
                              child: Text("Security measures",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 32.0, bottom: 16),
                              child: Text("Transfer of personal data",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 32.0, bottom: 16),
                              child: Text("International data transfers",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                          ...
                          InkWell(
                              ...
                              child: AnimatedDefaultTextStyle(
                                  style: link_hover_1 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                            : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                ...
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    WidgetSpan(child: InkWell(
                                        ...
                                        child: AnimatedDefaultTextStyle(
                                            style: link_hover_2 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                            duration: Duration(milliseconds: 200),
                                            child: Text("https://www.dataprivacyframework.gov/")))),
                                    TextSpan(text: ". We inform you in the context of the privacy notices which service providers we use are certified under the Data Privacy Framework.")
                                  ]
                                )
                            ),
                          )
                        ...
                        children: [
                          Center(
                            child: Padding(
                              ...
                              child: Text("Deletion of data",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                      ...
                      Column(
                        ...
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Use of cookies",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: RichText(
                              text: TextSpan(
                                  style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),
                                  children: [
                                    TextSpan(text: "General information on revocation and objection (so-called “opt-out”): ", style: TextStyle(fontWeight: FontWeight.w700)),
                                    TextSpan(text: "Users can revoke the consent they have given at any time and object to the processing in accordance with the legal requirements. For this purpose, users can, among other things, restrict the use of cookies in the settings of their browser (whereby this may also restrict the functionality of our online offer). An objection to the use of cookies for online marketing purposes can also be declared via the websites "),
                                    WidgetSpan(child: InkWell(
                                        onTap: () {},
                                        onHover: (bool) {
                                          setState(() {
                                        ...
                                        child: AnimatedDefaultTextStyle(
                                            style: link_hover_3 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                            duration: Duration(milliseconds: 200),
                                            child: Text("https://optout.aboutads.info")))),
                                    TextSpan(text: " and "),
                                    WidgetSpan(child: InkWell(
                                        onTap: () {},
                                        onHover: (bool) {
                                        ...
                                        child: AnimatedDefaultTextStyle(
                                            style: link_hover_4 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                            duration: Duration(milliseconds: 200),
                                            child: Text("https://www.youronlinechoices.com")))),
                                  ]
                              ),
                            ),
                          ),
                          ...
                          Padding(
                            padding: const EdgeInsets.only(top: 16.0),
                            child: Text("Further guidance on processing operations, procedures and services:",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(top: 16.0,left: 8),
                            child: Row(
                            ...
                            child: Column(
                              children: [
                                Center(
                                  child: Padding(
                                    padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                                    child: Text("Business services",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                                  ),
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(top: 16.0),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Provision of the online offer and web hosting",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                                ...
                                Flexible(
                                  child: RichText(
                                    text: TextSpan(
                                        style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),
                                        children: [
                                          TextSpan(text: "Collection of access data and log files: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Access to our online offer is logged in the form of so-called “server log files”. The server log files may include the address and name of the web pages and files accessed, date and time of access, data volumes transferred, notification of successful access, browser type and version, the user’s operating system, referrer URL (the previously visited page) and, as a rule, IP addresses and the requesting provider. The server log files may be used on the one hand for security purposes, for example, to prevent server overload (especially in the case of abusive attacks, so-called DDoS attacks) and on the other hand to ensure the utilization of the servers and their stability; "),
                                          TextSpan(text: "Legal basis: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Legitimate interests (Art. 6 para. 1 p. 1 lit. f) DSGVO). ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Deletion of data: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Log file information is stored for a maximum of 30 days and then deleted or anonymized. Data whose further storage is required for evidentiary purposes are exempt from deletion until final clarification of the respective incident."),
                                          TextSpan(text: "STRATO: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Services in the field of providing information technology infrastructure and related services (e.g..e.g. storage space and/or computing capacity); ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Service provider: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "STRATO AG, Pascalstraße 10,10587 Berlin, Germany; Legal basis: Legitimate interests (Art. 6 para 1 p. 1 lit. f) DSGVO); "),
                                          TextSpan(text: "Website: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          WidgetSpan(child: InkWell(
                                              onTap: () {},
                                              onHover: (bool) {
                                                setState(() {
                                              ...
                                              child: AnimatedDefaultTextStyle(
                                                  style: link_hover_5 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                      : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                  duration: Duration(milliseconds: 200),
                                                  child: Text("https://www.strato.de")))),
                                          ...
                                          WidgetSpan(child: InkWell(
                                              ...
                                              child: AnimatedDefaultTextStyle(
                                                  style: link_hover_6 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                      : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                  duration: Duration(milliseconds: 200),
                                                  child: Text("https://www.strato.de/datenschutz")))),
                                          TextSpan(text: " Basic third country transfer: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "EU-US Data Privacy Framework (DPF). "),
                                          TextSpan(text: "Introduction: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Content Delivery Network (CDN) – service, with the help of which content of an online offer, especially large media files, such as graphics or program scripts can be delivered faster and more securely with the help of regionally distributed servers connected via the Internet; "),
                                          TextSpan(text: "Service provider: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Instart Logic, Inc., 450 Lambert Avenue, Palo Alto, CA 94306, USA; "),
                                          TextSpan(text: "Legal basis: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          TextSpan(text: "Legitimate interests (Art. 6 para. 1 p. 1 lit. f) DSGVO); "),
                                          TextSpan(text: "Website: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          WidgetSpan(child: InkWell(
                                              ...
                                              child: AnimatedDefaultTextStyle(
                                                  style: link_hover_7 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                      : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                  duration: Duration(milliseconds: 200),
                                                  child: Text("https://www.instart.com")))),
                                          TextSpan(text: " Privacy Policy: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                          WidgetSpan(child: InkWell(
                                              onTap: () {},
                                              onHover: (bool) {
                                              ...
                                              child: AnimatedDefaultTextStyle(
                                                  style: link_hover_8 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                      : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                  duration: Duration(milliseconds: 200),
                                                  child: Text("https://www.instart.com/company/legal/privacy-policy")))),
                                        ]
                                    ),
                                  ),
                                ),
                      ...
                      Column(
                        ...
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Registration, login and user account",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                        ...
                        child: Column(
                          children: [
                            Center(
                              child: Padding(
                                padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                                child: Text("Single sign-on login",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(top: 16.0),
                                  ...
                                  Flexible(
                                    child: RichText(
                                      text: TextSpan(
                                          style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),
                                          children: [
                                            TextSpan(text: "Google Single-Sign-On: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: " Authentication service; "),
                                            TextSpan(text: "Service Provider: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Ireland; "),
                                            TextSpan(text: "Legal basis: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Legitimate interests (Art. 6 para 1 p. 1 lit. f) DSGVO); "),
                                            TextSpan(text: "Website: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            WidgetSpan(child: InkWell(
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_16 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                            ...
                                            WidgetSpan(child: InkWell(
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_17 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://policies.google.com/privacy")))),
                                            TextSpan(text: " Basic Third Country Transfer: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "EU-US Data Privacy Framework (DPF)."),
                                            TextSpan(text: " Opposition (Opt-Out): ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Ad Display Settings: "),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                  setState(() {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_18 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://adssettings.google.com/authenticated")))),
                                          ]
                                      ),
                                    ),
                                  ),
                        ...
                        child: Column(
                          children: [
                            Center(
                              child: Padding(
                                padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                                child: Text("Web analytics, monitoring and optimization",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(top: 16.0),
                                      ...
                                      text: TextSpan(
                                          ...
                                          children: [
                                            ...
                                            WidgetSpan(child: InkWell(
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_9 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://marketingplatform.google.com/intl/de/about/analytics")))),
                                            TextSpan(text: " Privacy Policy: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_10 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://policies.google.com/privacy")))),
                                            TextSpan(text: " Assprocessorms Agreement: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                  setState(() {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_11 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://business.safety.google/adsprocessorterms/")))),
                                            TextSpan(text: " Basic Third Country Transfer: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "EU-US Data Privacy Framework (DPF), Standard Contractual Clauses ("),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                  setState(() {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_12 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://business.safety.google/adsprocessorterms")))),
                                            TextSpan(text: ");"),
                                            TextSpan(text: " Opposition (Opt-Out): ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Opt-Out Plugin: "),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                  setState(() {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_13 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://tools.google.com/dlpage/gaoptout?hl=de")))),
                                            TextSpan(text: ", Ad Display Settings:"),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_14 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://adssettings.google.com/authenticated")))),
                                            TextSpan(text: " More information: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                  setState(() {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_15 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://privacy.google.com/businesses/adsservices")))),
                                            TextSpan(text: " (types of processing as well as data processed)."),
                                          ]
                                      ),
                                    ),
                                  ),
                        ...
                        child: Column(
                          children: [
                            Center(
                              child: Padding(
                                padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                                child: Text("Plugins and embedded features and content",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.only(top: 16.0),
                                  ...
                                  Flexible(
                                    child: RichText(
                                      text: TextSpan(
                                          style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),
                                          children: [
                                            TextSpan(text: "Integration of third-party software, scripts or frameworks (e.g. jQuery): ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "We integrate software into our online offer that we retrieve from servers of other providers (e.g. function libraries that we use for the purpose of presentation or user-friendliness of our online offer). In doing so, the respective providers collect the IP address of the users and may process this for the purpose of transmitting the software to the user’s browser and for security purposes, as well as for the evaluation and optimization of their offer. – We integrate software into our online offer that we retrieve from servers of other providers (e.g. function libraries that we use for the purpose of presentation or user-friendliness of our online offer). Here, the respective providers collect the IP address of users and may process it for purposes of transmission of the software to the user’s browser and for purposes of security, as well as for evaluation and optimization of their offer; "),
                                            TextSpan(text: "Legal basis: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Legitimate interests (Art. 6 para. 1 p. 1 lit. f) DSGVO)."),
                                            TextSpan(text: "Google Fonts (provision on own server): ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Provision of font files for the purpose of a user-friendly presentation of our online offer; "),
                                            TextSpan(text: "Service provider: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "The Google Fonts are hosted on our server, no data is transmitted to Google; "),
                                            TextSpan(text: "Legal basis: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Legitimate interests (Art. 6 para 1 p. 1 lit. f) DSGVO). "),
                                            TextSpan(text: "OpenStreetMap: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "We incorporate the maps of the service “OpenStreetMap”, which are offered on the basis of the Open Data Commons Open Database License (ODbL) by the OpenStreetMap Foundation (OSMF). User data is used by OpenStreetMap solely for the purposes of displaying the map functions and for caching the selected settings. This data may include, in particular, IP addresses and location data of users, which, however, are not collected without their consent (usually executed in the context of the settings of their terminal devices or browsers); "),
                                            TextSpan(text: "Service provider: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "OpenStreetMap Foundation (OSMF); "),
                                            TextSpan(text: "Legal basis: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            TextSpan(text: "Legitimate interests (Art. 6 para 1 p. 1 lit. f) DSGVO); "),
                                            TextSpan(text: "Website: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            WidgetSpan(child: InkWell(
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_16 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://www.openstreetmap.de/")))),
                                            TextSpan(text: " Privacy Policy: ", style: TextStyle(fontWeight: FontWeight.w700)),
                                            WidgetSpan(child: InkWell(
                                                onTap: () {},
                                                onHover: (bool) {
                                                ...
                                                child: AnimatedDefaultTextStyle(
                                                    style: link_hover_17 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                        : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                    duration: Duration(milliseconds: 200),
                                                    child: Text("https://wiki.osmfoundation.org/wiki/Privacy_Policy")))),
                                          ]
                                      ),
                                    ),
                                  ),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Change and update privacy policy",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Definitions of terms",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Data transfer to Firebase and Google AdMob",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                          ...
                          Padding(
                            padding: const EdgeInsets.only(top: 16.0),
                            child: Text("Firebase: ",
                              style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(top: 16.0,left: 8),
                            child: Row(
                                ...
                                Flexible(
                                  child: RichText(
                                    text: TextSpan(
                                        style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016),
                                        children: [
                                          TextSpan(text: "Advertising-related information: "),
                                          TextSpan(text: "Google AdMob may collect information about ad views, interactions with ads, and advertising IDs. This information is used by Google AdMob to deliver personalized ads and analyze advertising performance. For more information about Google AdMob’s privacy practices, please visit"),
                                          WidgetSpan(child: InkWell(
                                              onTap: () {},
                                              onHover: (bool) {
                                                setState(() {
                                              ...
                                              child: AnimatedDefaultTextStyle(
                                                  style: link_hover_19 ? TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(227, 176, 75, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline)
                                                      : TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w400,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.016,decoration: TextDecoration.underline),
                                                  duration: Duration(milliseconds: 200),
                                                  child: Text("https://support.google.com/admob/answer/6128543?hl=en"))))
                                        ]
                                    ),
                                  ),
                                ),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("Storage duration of the data at Firebase and Google AdMob",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
                      ...
                      Column(
                        children: [
                          Center(
                            child: Padding(
                              padding: const EdgeInsets.only(top: 48.0, bottom: 16),
                              child: Text("opt-out option",style: TextStyle(fontFamily: "Roboto",fontWeight: FontWeight.w700,color: Color.fromRGBO(43, 43, 40, 1),fontSize: MediaQuery.of(context).size.height * 0.025),),
                            ),
                          ),
