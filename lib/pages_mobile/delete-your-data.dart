                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "Delete your Data",
                                      style: TextStyle(fontFamily: "Roboto", fontWeight: FontWeight.w800, color: const Color.fromRGBO(43, 43, 40, 1), fontSize: MediaQuery.of(context).size.height * 0.04),
                                    ),
                                  ],
                                ),
                              ),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(fontFamily: "Roboto",color: Color.fromRGBO(43, 43, 40 , 1),fontWeight: FontWeight.w700,fontSize: MediaQuery.of(context).size.height * 0.028),
                                          textAlign: TextAlign.center,
                                        ),
                                        SizedBox(
